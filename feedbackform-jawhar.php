...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO feedback_jawhar(post, date, time1, time2, checkbox1, checkbox2, checkbox3, checkbox4, checkbox5, checkbox6, checkbox7,checkbox8, checkbox9, checkbox10, checkbox11, checkbox12, select1, select2, select3, textarea1, textarea2, mobile_no, name) 
